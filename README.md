...
**Before every commit** the staged change is checked against what was decided. A blocking conflict stops the commit once and tells Claude why, so it asks you; run the same commit again and it goes through. Every other command is untouched.
